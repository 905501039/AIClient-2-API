...
const translations = {
    'zh-CN': {
        ...
        'modal.provider.refreshAllUuids': '刷新全部UUID',
        'modal.provider.refreshAllUuidsBtn': '刷新全部UUID',
        'modal.provider.refreshAllUuidsConfirm': '确定要刷新 {count} 个节点的UUID吗？',
        'modal.provider.refreshAllUuids.noProviders': '没有可刷新节点',
        'modal.provider.refreshAllUuids.refreshing': '正在刷新...',
        'modal.provider.refreshAllUuids.success': '已刷新 {count} 个节点的UUID',
        'modal.provider.refreshAllUuids.failed': '刷新失败',
        'modal.provider.checkCredentialsUnlink': '检测凭证并取消关联',
        'modal.provider.checkCredentialsUnlinkBtn': '检测凭证',
        'modal.provider.checkCredentialsUnlinkConfirm': '确定要检测 {count} 个节点的凭证吗？',
        'modal.provider.checkCredentialsUnlink.noProviders': '没有可检测节点',
        'modal.provider.checkCredentialsUnlink.checking': '正在检测...',
        'modal.provider.checkCredentialsUnlink.complete': '检测完成: {success} 健康, {fail} 异常, {unlinked} 已取消关联',
        'modal.provider.checkCredentialsUnlink.failed': '检测失败',
    ...
    'en-US': {
        ...
        'modal.provider.refreshAllUuids': 'Refresh all UUIDs',
        'modal.provider.refreshAllUuidsBtn': 'Refresh all UUIDs',
        'modal.provider.refreshAllUuidsConfirm': 'Refresh UUIDs for {count} node(s)?',
        'modal.provider.refreshAllUuids.noProviders': 'No nodes to refresh',
        'modal.provider.refreshAllUuids.refreshing': 'Refreshing...',
        'modal.provider.refreshAllUuids.success': 'Refreshed {count} UUID(s)',
        'modal.provider.refreshAllUuids.failed': 'Refresh failed',
        'modal.provider.checkCredentialsUnlink': 'Check credentials & unlink',
        'modal.provider.checkCredentialsUnlinkBtn': 'Check credentials',
        'modal.provider.checkCredentialsUnlinkConfirm': 'Check credentials for {count} node(s)?',
        'modal.provider.checkCredentialsUnlink.noProviders': 'No nodes to check',
        'modal.provider.checkCredentialsUnlink.checking': 'Checking...',
        'modal.provider.checkCredentialsUnlink.complete': 'Check complete: {success} healthy, {fail} abnormal, {unlinked} unlinked',
        'modal.provider.checkCredentialsUnlink.failed': 'Check failed',
